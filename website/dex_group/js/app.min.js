...
$(".contacts__faq-item .title").click(function () {
...
$(".header__bottom .clous-btn").click(function () {
    $(".header__bottom").slideUp(500)
})

$(".header__catalog-btn").click(function () {
    $(".header__catalog-hiden").slideToggle(500)
})



var swiper = new Swiper(".swiper-thumbs .swiper", {
    loop: true,
    spaceBetween: 16,
    slidesPerView: "auto",
    navigation: {
        nextEl: ".gallery-swiper .slidenext",
        prevEl: ".gallery-swiper .slideprev",
    },
});
var swiper2 = new Swiper(".gallery-swiper .swiper", {
    loop: true,
    spaceBetween: 10,
    slidesPerView: "auto",
    navigation: {
